...
?>
        ...
        <head>
            ...
            <title>Газпромбанк | <?= $pageName; ?></title>
            ...
            <link rel="stylesheet" href="./public/css/gazprombank.bundle.css">
            <?php
            switch ($pageName) {
                case 'Review':
                ?>
                    <link rel="stylesheet" href="./public/css/plugins/select2.min.css" />
                    <link rel="stylesheet" href="./public/css/plugins/daterangepicker.min.css" />
                <?
                    break;
    ...
    ?>
        ...
        switch ($pageName) {
            ...
            case 'Review':
                ...
                <script src="./public/js/plugins/daterangepicker.min.js"></script>
                <script src="./public/js/plugins/select2.min.js"></script>
                <script src="./public/js/plugins/chart.umd.min.js"></script>
                <script src="./public/js/plugins/gridjs.umd.js"></script>
                <script src="./public/js/pages/review.js"></script>
                <?
                break;
            ...
            case 'Reviews':
                ...
                <script src="./public/js/plugins/chart.umd.min.js"></script>
                <script src="./public/js/plugins/gridjs.umd.js"></script>
                <script src="./public/js/pages/reviews.js"></script>
                <?
                break;
        ...
        public function gazprombankHeader($pageName)
        {
            ...
            <nav class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="mobile-menu hidden md:hidden pb-3">
                    <div class="space-y-1 px-2 border-t border-gray-200 pt-3">
                        <a href="/reviews" class="block rounded-md px-3 py-2 text-base font-medium <?php if ($pageName == "Review") { ?>!text-sky-600 !rounded-md !bg-sky-50<?php } ?> text-gray-700 hover:bg-gray-100">
                            Обзор
                        </a>
                        <a href="/reviews" class="block rounded-md px-3 py-2 text-base font-medium <?php if ($pageName == "Reviews") { ?>!text-sky-600 !rounded-md !bg-sky-50<?php } ?> text-gray-700 hover:bg-gray-100">
                            Отзывы
                        </a>
                        <a href="/settings" class="block rounded-md px-3 py-2 text-base font-medium <?php if ($pageName == "Settings") { ?>!text-sky-600 !rounded-md !bg-sky-50<?php } ?> text-gray-700 hover:bg-gray-100">
                            Настройки
                        </a>
    ...
    <?php
        ...
        public function gazprombankFooter()
        {
    ?>
            ...
            <div class="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
                <div class="mt-8 md:order-1 md:mt-0">
                    <p class="text-center text-xs leading-5 text-gray-500">
                        &copy; <?php echo (date("Y")); ?> Газпромбанк. Все права защищены.
                    </p>
                </div>
            </div>
        </footer>
