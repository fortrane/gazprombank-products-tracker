function addNotification(title, text, svgType) {
    ...
    <div aria-live="assertive" class="pointer-events-none w-80 mb-2 new-notification z-[9999]">
        <div class="flex w-full flex-col items-center space-y-4 sm:items-end">
            <div class="transform ease-out duration-300 transition pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black/5 translate-y-2 opacity-0 sm:translate-y-0 sm:translate-x-2 new-notification-panel">
            <div class="p-4">
                ...
                <div class="ml-4 flex flex-shrink-0">
                    <button type="button" class="inline-flex rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-600 focus:ring-offset-2 close-btn">
